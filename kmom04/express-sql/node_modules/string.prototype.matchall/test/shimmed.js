...
test('shimmed', function (t) {
    ...
    t.test('Symbol.matchAll', { skip: !hasSymbols }, function (st) {
        ...
        st.test('no symbol present', function (s2t) {
            ...
            s2t.doesNotThrow(function () {
                'abc'.matchAll('b'); }, 'does not throw on string input, with the symbol on regex prototype');
            ...
            s2t['throws'](function () {
                'abc'.matchAll('b'); }, 'throws on string input, without the symbol on regex prototype');
